...
public class HorizontalScrollViewWrapper extends ViewWrapper<HorizontalScrollView> {
    ...
    public HorizontalScrollViewWrapper() {
    ...
    public static View build(Object prev, HashMap<String, Object> props, boolean designer, Object tag) throws Exception {
        ...
        String str2 = "innerWidth";
        if (props.containsKey(str)) {
            BALayout b = new BALayout((Context) tag);
            String str3 = "innerWidth";
            v.addView(b, (int) (BALayout.getDeviceScale() * ((float) ((Integer) props.get(str)).intValue())), -1);
            if (d != null) {
