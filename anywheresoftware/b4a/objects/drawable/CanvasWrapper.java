...
public class CanvasWrapper {
    ...
    public static class RectWrapper extends AbsObjectWrapper<Rect> {
        ...
        public String toString() {
            ...
            str2 = ", ";
            str2 = ", ";
            return new StringBuilder(String.valueOf(s)).append("(").append(getLeft()).append(str).append(getTop()).append(str).append(getRight()).append(str).append(getBottom()).append(")").toString();
        }
    }
