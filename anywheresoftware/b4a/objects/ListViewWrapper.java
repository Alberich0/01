...
public class ListViewWrapper extends ViewWrapper<SimpleListView> {
    ...
    /* renamed from: anywheresoftware.b4a.objects.ListViewWrapper.1 */
    class C00241 implements OnItemClickListener {
        private final /* synthetic */ BA val$ba;
        private final /* synthetic */ String val$eventName;

        C00241(BA ba, String str) {
            this.val$ba = ba;
            this.val$eventName = str;
        }

        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            this.val$ba.raiseEventFromUI(ListViewWrapper.this.getObject(), this.val$eventName + "_itemclick", Integer.valueOf(position), ((SimpleListView) ListViewWrapper.this.getObject()).adapter.getItem(position));
        }
    }

    /* renamed from: anywheresoftware.b4a.objects.ListViewWrapper.2 */
    class C00252 implements OnItemLongClickListener {
        private final /* synthetic */ BA val$ba;
        private final /* synthetic */ String val$eventName;

        C00252(BA ba, String str) {
            this.val$ba = ba;
            this.val$eventName = str;
        }

        public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id) {
            this.val$ba.raiseEventFromUI(ListViewWrapper.this.getObject(), this.val$eventName + "_itemlongclick", Integer.valueOf(position), ((SimpleListView) ListViewWrapper.this.getObject()).adapter.getItem(position));
            return true;
        }
    }
    ...
    public void innerInitialize(BA ba, String eventName, boolean keepOldObject) {
        ...
        if (ba.subExists(new StringBuilder(String.valueOf(eventName)).append("_itemclick").toString())) {
            ((SimpleListView) getObject()).setOnItemClickListener(new C00241(ba, eventName));
        }
        if (ba.subExists(new StringBuilder(String.valueOf(eventName)).append("_itemlongclick").toString())) {
            ((SimpleListView) getObject()).setOnItemLongClickListener(new C00252(ba, eventName));
        }
    }
