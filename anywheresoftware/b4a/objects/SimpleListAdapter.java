...
public class SimpleListAdapter extends BaseAdapter implements ListAdapter {
    ...
    public static class SingleLineData implements SimpleItem {
        ...
        public void updateExisting(ViewGroup layout, SimpleListAdapter adapter) {
            ((TextView) layout.getChildAt(SimpleListAdapter.SINGLE_LINE_ITEM)).setText(this.Text);
        }

        @Hide
        public int getType() {
            return SimpleListAdapter.SINGLE_LINE_ITEM;
        }
    ...
    public static class SingleLineLayout implements ItemLayout {
        ...
        private SingleLineLayout(ViewGroup dummyParent, boolean dontSetLayout) {
            ...
            if (!dontSetLayout) {
                ...
                t.setGravity(16);
                dummyParent.addView(t, new LayoutParams(Common.DipToCurrent(5), SimpleListAdapter.SINGLE_LINE_ITEM, -1, -1));
            }
        }
    ...
    public static class TwoLinesData extends SingleLineData {
        ...
        public void updateExisting(ViewGroup layout, SimpleListAdapter adapter) {
            ...
            ((TextView) layout.getChildAt(SimpleListAdapter.TWO_LINES_ITEM)).setText(this.SecondLineText);
        }

        @Hide
        public int getType() {
            return SimpleListAdapter.TWO_LINES_ITEM;
        }
    }
    ...
    public static class TwoLinesAndBitmapData extends TwoLinesData {
        ...
        public void updateExisting(ViewGroup layout, SimpleListAdapter adapter) {
            super.updateExisting(layout, adapter);
            ImageView iv = (ImageView) layout.getChildAt(SimpleListAdapter.TWO_LINES_AND_BITMAP_ITEM);
            iv.setVisibility(this.Bitmap != null ? SimpleListAdapter.SINGLE_LINE_ITEM : 8);
            if (this.Bitmap != null) {
        ...
        @Hide
        public int getType() {
            return SimpleListAdapter.TWO_LINES_AND_BITMAP_ITEM;
        }
    }
    ...
    public static class TwoLinesLayout extends SingleLineLayout {
        ...
        private TwoLinesLayout(ViewGroup dummyParent, boolean dontSetLayout) {
            ...
            if (!dontSetLayout) {
                ...
                dummyParent.addView(t, new LayoutParams(Common.DipToCurrent(5), SimpleListAdapter.SINGLE_LINE_ITEM, -1, Common.DipToCurrent(30)));
    ...
    public static class TwoLinesAndBitmapLayout extends TwoLinesLayout {
        ...
        private TwoLinesAndBitmapLayout(ViewGroup dummyParent) {
            ...
            t.setTextColor(-1);
            t2.setTextColor(Colors.Gray);
            dummyParent.addView(t, new LayoutParams(Common.DipToCurrent(60), SimpleListAdapter.SINGLE_LINE_ITEM, -1, Common.DipToCurrent(30)));
    ...
    public SimpleListAdapter(Context context) {
        ...
        this.SingleLine = new SingleLineLayout(false, null, null);
        this.TwoLines = new TwoLinesLayout(false, null, null);
        this.TwoLinesAndBitmap = new TwoLinesAndBitmapLayout(null);
        this.layouts = new ItemLayout[3];
        this.layouts[SINGLE_LINE_ITEM] = this.SingleLine;
        this.layouts[TWO_LINES_ITEM] = this.TwoLines;
        this.layouts[TWO_LINES_AND_BITMAP_ITEM] = this.TwoLinesAndBitmap;
    }
