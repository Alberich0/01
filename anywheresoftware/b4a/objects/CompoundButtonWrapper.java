...
public class CompoundButtonWrapper<T extends CompoundButton> extends TextViewWrapper<T> {
    ...
    /* renamed from: anywheresoftware.b4a.objects.CompoundButtonWrapper.1 */
    class C00201 implements OnCheckedChangeListener {
        private final /* synthetic */ BA val$ba;
        private final /* synthetic */ String val$eventName;

        C00201(BA ba, String str) {
            this.val$ba = ba;
            this.val$eventName = str;
        }

        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            this.val$ba.raiseEvent2(CompoundButtonWrapper.this.getObject(), false, this.val$eventName + "_checkedchange", false, Boolean.valueOf(isChecked));
        }
    }
    ...
    protected void innerInitialize(BA ba, String eventName, boolean keepOldObject, boolean addCheckedChangeEvent) {
        super.innerInitialize(ba, eventName, true);
        if (ba.subExists(new StringBuilder(String.valueOf(eventName)).append("_checkedchange").toString())) {
            ((CompoundButton) getObject()).setOnCheckedChangeListener(new C00201(ba, eventName));
        }
    }
