...
public class ViewWrapper<T extends View> extends AbsObjectWrapper<T> implements B4aDebuggable {
    ...
    /* renamed from: anywheresoftware.b4a.objects.ViewWrapper.1 */
    class C00311 implements OnClickListener {
        private final /* synthetic */ BA val$ba;
        private final /* synthetic */ String val$eventName;

        C00311(BA ba, String str) {
            this.val$ba = ba;
            this.val$eventName = str;
        }

        public void onClick(View v) {
            this.val$ba.raiseEvent(ViewWrapper.this.getObject(), this.val$eventName + "_click", new Object[0]);
        }
    }

    /* renamed from: anywheresoftware.b4a.objects.ViewWrapper.2 */
    class C00322 implements OnLongClickListener {
        private final /* synthetic */ BA val$ba;
        private final /* synthetic */ String val$eventName;

        C00322(BA ba, String str) {
            this.val$ba = ba;
            this.val$eventName = str;
        }

        public boolean onLongClick(View v) {
            this.val$ba.raiseEvent(ViewWrapper.this.getObject(), this.val$eventName + "_longclick", new Object[0]);
            return true;
        }
    }
    ...
    public void innerInitialize(BA ba, String eventName, boolean keepOldObject) {
        ...
        if (ba.subExists(new StringBuilder(String.valueOf(eventName)).append("_click").toString())) {
            ((View) getObject()).setOnClickListener(new C00311(ba, eventName));
        }
        if (ba.subExists(new StringBuilder(String.valueOf(eventName)).append("_longclick").toString())) {
            ((View) getObject()).setOnLongClickListener(new C00322(ba, eventName));
        }
    }
    ...
    public static <T> T buildNativeView(Context context, Class<T> cls, HashMap<String, Object> props, boolean designer) throws IllegalArgumentException, SecurityException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
        ...
        if (overideClass != null) {
            String str2 = ".";
            if (overideClass.startsWith(str)) {
        ...
        if (!(designer || overideClass == null)) {
            try {
                ...
                str2 = ".";
                int i = overideClass.lastIndexOf(str);
