...
public class TabHostWrapper extends ViewWrapper<TabHost> {
    ...
    /* renamed from: anywheresoftware.b4a.objects.TabHostWrapper.1 */
    class C00301 implements OnTabChangeListener {
        private final /* synthetic */ BA val$ba;
        private final /* synthetic */ String val$eventName;

        C00301(BA ba, String str) {
            this.val$ba = ba;
            this.val$eventName = str;
        }

        public void onTabChanged(String tabId) {
            this.val$ba.raiseEvent2(TabHostWrapper.this.getObject(), false, this.val$eventName + "_tabchanged", false, new Object[0]);
        }
    }
    ...
    public void innerInitialize(BA ba, String eventName, boolean keepOldObject) {
        ...
        if (ba.subExists(new StringBuilder(String.valueOf(eventName)).append("_tabchanged").toString())) {
            ((TabHost) getObject()).setOnTabChangedListener(new C00301(ba, eventName));
        }
